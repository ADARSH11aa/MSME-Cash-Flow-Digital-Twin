...
/**
 * Marketing shell — sticky dark top nav and footer, matching the reference
 * frames' landing-page chrome (PRD 3.1).
 */
...
export default function MarketingLayout() {
  ...
  return (
    <div className="min-h-screen bg-void">
      ...
      <header className="sticky top-0 z-40 border-b border-edge-dark bg-void/95 backdrop-blur">
        <nav
          aria-label="Main"
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
          ...
          {columns.map((column) => (
            <div key={column.title}>
              <h2 className={cn('text-label-xs uppercase text-chalk-hi')}>{column.title}</h2>
